...
merged_results <- read.csv(file.path(results_dir, "nesmr_vs_genomic_sem_results.csv")) %>%
...
ggsave(file.path(results_dir, "nesmr_vs_genomic_sem_bias_40000.jpeg"), p1, width = 14, height = 14, dpi = 300)
ggsave(file.path(results_dir, "nesmr_vs_genomic_sem_bias_10000.jpeg"), p2, width = 14, height = 14, dpi = 300)

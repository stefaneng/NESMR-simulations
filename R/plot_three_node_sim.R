...
ggsave(
    filename = file.path(output_collider_dir, sprintf('%s_QQ_collider_3node_r2_thresholds.jpeg', Sys.Date())),
...
ggsave(
    filename = file.path(output_mediation_dir, sprintf('%s_QQ_mediation_3node_pval_thresholds.jpeg', Sys.Date())),
